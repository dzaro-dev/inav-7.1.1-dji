...
#define DJI_SYM_HOME_NEAR               0x7E
#define DJI_SYM_RPM                     0x12
#define DJI_SYM_ROLL                    0x14
#define DJI_SYM_PITCH                   0x15
#define DJI_SYM_TEMP                    0x7A
#define DJI_SYM_MAX                     0x24 // MAX Symbol

// Glide calculations
#define DJI_SYM_GLIDESLOPE              0x05 // Pyramid Symbol
#define DJI_SYM_GLIDE_DIST              0x24 // MAX Symbol
...
#define DJI_SYM_TOTAL_DISTANCE          0x12 // RPM resembles round trip distance (DJI_SYM_RPM)
#define DJI_SYM_OVER_HOME               0x2A // Star Symbol
#define DJI_SYM_WAYPOINT                0x40 // @ Symbol
#define DJI_SYM_HEADING                 0x00 // Blank Space (DJI_SYM_NONE)
#define DJI_SYM_DEGREES                 0x08 // Blank Space (DJI_SYM_NONE)
...
#define DJI_SYM_MILES                   DJI_SYM_M // Meters and Miles share symbol 
...
#define DJI_SYM_GPS_DEGREE              0x08 // DJI_SYM_STICK_OVERLAY_SPRITE_HIGH - kind of looks like the degree symbol
